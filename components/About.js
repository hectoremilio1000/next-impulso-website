      ...
      <div className="max-w-[1300px] mx-auto px-[20px]">
        <div className="w-full flex justify-end">
          <div className="box shadow-2xl md:w-1/2 bg-white border-[1px] border-[#e5e5e5] rounded-[1.2em] p-8 md:py-16 md:px-16 flex flex-col">
            <h1 className=" titlebanner-tw text-center text-clip mb-1 md:mb-4">Impulso</h1>
            <h1 className=" titlebanner-tw text-center mb-4">
               Restaurantero
            </h1>
            ...
            <p className="title4-tw paragraph-feature mb-6">
              Fundada en 2024, hemos trabajado con más de 10
              restauranteros en México, creando más de 100 restaurantes que
            ...
            <div className="flex justify-around mt-6">
              ...
              <div>
                <h1 className="counter font-bold ">+1000%</h1>
